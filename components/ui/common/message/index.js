                ...
                <div className="flex items-center justify-between flex-wrap">
                    ...
                    <div className="order-2 flex-shrink-0 sm:order-3 sm:ml-3">
                        <button
                            ...
                            <svg className={`h-6 w-6 text-${messageType}-900 hover:bg-indigo-200 rounded-sm`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
